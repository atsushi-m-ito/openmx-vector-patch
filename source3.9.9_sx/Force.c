...
//#pragma omp parallel  /* omp is invalid by optimization for NEC */
	{
...
#pragma _NEC ivdep
	      for (int j=0; j<30; j++){
            if(j<NO1){
    	      //tmp0 += Orbs_Grid[Mh_AN][Nh][j] * DM[0][spin][Mc_AN][h_AN][i][j];
		  ...
		  const double Vpt = Vpot_grid[spin][Nc];          
		  sumx += dChi0[Nc][i][0] * tmp0 * Vpt;
		  sumy += dChi0[Nc][i][1] * tmp0 * Vpt;
	      sumz += dChi0[Nc][i][2] * tmp0 * Vpt;
	    }/* Nog */
	  }	
    }/* spin */
  }else{
...
#pragma _NEC loop_count(1000)
  ...
  const double tmp0 = Orbs_Grid_FNAN_t3[j][Nog] * DM[0][spin][Mc_AN][h_AN][i][j];
...
#pragma _NEC loop_count(1000)
  ...
  const double tmp0 = Orbs_Grid[Mh_AN][Nh][j] * DM[0][spin][Mc_AN][h_AN][i][j];
	...
	/* due to difference in the definition between density matrix and density */
	const double Vpt = Vpot_grid[spin][Nc];
	sumx += ai_dorbs0[i][0] * tmp0 * Vpt;
	sumy += ai_dorbs0[i][1] * tmp0 * Vpt;
	sumz += ai_dorbs0[i][2] * tmp0 * Vpt;
}/* Nog */
	  }
	}
  }/* spin */
...
//#pragma omp barrier      /* this barrier is necessary to wait clearing */
  ...
  /* if (h_AN!=0 && where_flag==1) */
   ...
   for (l1=1; l1<=Spe_Num_RVPS[wakg]; l1++){
	...
	if(l<=24)
	{
        for (m=0; m<ian; m++){
          for (l3=0; l3<l ; l3++){
            tno0_m[1][m][l3] = DS_NL1[0][1][Matomnum+1][kl1][m][l3];
            tno0_m[2][m][l3] = DS_NL1[0][2][Matomnum+1][kl1][m][l3];
            tno0_m[3][m][l3] = DS_NL1[0][3][Matomnum+1][kl1][m][l3];
          }
        }
        for (n=0; n<jan; n++){
          for (l3=0; l3<l ; l3++) tno0_n[0][n][l3] = DS_NL1[0][0][Matomnum+1][kl2][n][l3];
        }
	...
	else
	{
      for (int x=0; x<ian*jan; x++){
        ...
        for (l3=0; l3<l; l3++){
          ene = eneValues[l3];
         Sumx_[x] -= ene*DS_NL1[0][1][Matomnum+1][kl1][m][l3]*DS_NL1[0][0][Matomnum+1][kl2][n][l3];
         Sumy_[x] -= ene*DS_NL1[0][2][Matomnum+1][kl1][m][l3]*DS_NL1[0][0][Matomnum+1][kl2][n][l3];
         Sumz_[x] -= ene*DS_NL1[0][3][Matomnum+1][kl1][m][l3]*DS_NL1[0][0][Matomnum+1][kl2][n][l3];
        }
      }
...
free(eneValues);
   ...
   for (l1=1; l1<=Spe_Num_RVPS[wakg]; l1++){
	...
	if(l<=24)
	{
        for (m=0; m<ian; m++){
          for (l3=0; l3<l ; l3++){
            tno0_m[1][m][l3] = DS_NL1[0][0][Matomnum+1][kl1][m][l3];
          }
        }
        for (n=0; n<jan; n++){
          for (l3=0; l3<l ; l3++) 
	{
        tno0_n[1][n][l3] = DS_NL1[0][1][Matomnum+1][kl2][n][l3];
	tno0_n[2][n][l3] = DS_NL1[0][2][Matomnum+1][kl2][n][l3];
	tno0_n[3][n][l3] = DS_NL1[0][3][Matomnum+1][kl2][n][l3];
        }
        }
      ...
      for (int x=0; x<ian*jan; x++){
        ...
        for (l3=0; l3<24; l3++){
          ene = eneValues[l3];
          Sumx_[x] -= ene*tno0_m[1][m][l3]*tno0_n[1][n][l3];
          Sumy_[x] -= ene*tno0_m[1][m][l3]*tno0_n[2][n][l3];
          Sumz_[x] -= ene*tno0_m[1][m][l3]*tno0_n[3][n][l3];
   }
	...
	else
	{
      for (int x=0; x<ian*jan; x++){
        ...
        for (l3=0; l3<l; l3++){
          ene = eneValues[l3];
          Sumx_[x] -= ene*DS_NL1[0][0][Matomnum+1][kl1][m][l3]*DS_NL1[0][1][Matomnum+1][kl2][n][l3];
          Sumy_[x] -= ene*DS_NL1[0][0][Matomnum+1][kl1][m][l3]*DS_NL1[0][2][Matomnum+1][kl2][n][l3];
          Sumz_[x] -= ene*DS_NL1[0][0][Matomnum+1][kl1][m][l3]*DS_NL1[0][3][Matomnum+1][kl2][n][l3];
        }
      }
	}
#endif
