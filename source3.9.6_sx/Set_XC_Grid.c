...
static const double pbe_p[3]      = {1.0000000,  1.0000000,  1.0000000};
static const double pbe_A[3]      = {0.0310910,  0.0155450,  0.0168870};
static const double pbe_alpha1[3] = {0.2137000,  0.2054800,  0.1112500};
static const double pbe_beta1[3]  = {7.5957000, 14.1189000, 10.3570000};
static const double pbe_beta2[3]  = {3.5876000,  6.1977000,  3.6231000};
static const double pbe_beta3[3]  = {1.6382000,  3.3662000,  0.8802600};
static const double pbe_beta4[3]  = {0.4929400,  0.6251700,  0.4967100};
...
#pragma omp parallel shared(dDen_Grid,dEXC_dGD,den_min,Vxc0,Vxc1,Vxc2,Vxc3,My_NumGridD,XC_P_switch,XC_switch,Den0,Den1,Den2,Den3,PCC_switch,PCCDensity_Grid_D) private(OMPID,Nthrds,MN,tot_den,tmp0,tmp1,ED,Exc,Ec_unif,Vc_unif,Vxc,Ex_unif,Vx_unif,GDENS,DEXDD,DECDD,DEXDGD,DECDGD)
      ...
      case 4:
  {
    ...
    OMPID = omp_get_thread_num();
    Nthrds = omp_get_num_threads();
	const int MN_bigen = (My_NumGridD * (OMPID)) / Nthrds;
	const int MN_end = (My_NumGridD * (OMPID+1)) / Nthrds;
#pragma _NEC loop_count(10000)
#pragma _NEC vector
#pragma _NEC ivdep
	for (int MN=MN_bigen; MN<MN_end; ++MN){
